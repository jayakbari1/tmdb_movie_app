...
import 'package:tmdb_movie_app/pages/sliver_page_view/sliver_page_list_view.dart';
...
class SliverMoviePageList extends StatelessWidget {
  const SliverMoviePageList({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: const SwitchCase(
        paginationWidget: SliverPageListView(),
